...
provides such computational support and allows insight into the complex networks of signaling events occurring in living cells.
...
\end{center}
\caption{\csentence{Signaling network downstream of TNF$\alpha$ and EGF in human colon carcinoma cells: improved model.}
