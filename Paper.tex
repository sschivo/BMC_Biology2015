...
\pgfdeclareimage[width=\textwidth]{100TNF0EGF}{images/TNFa-EGF/100TNFa-0EGF/100TNF_0EGF_ANIMOvsFuzzy-crop}
\pgfdeclareimage[width=\textwidth]{0TNF100EGF}{images/TNFa-EGF/0TNFa-100EGF/0TNF_100EGF_ANIMOvsFuzzy-crop}
\pgfdeclareimage[width=\textwidth]{100TNF100EGF}{images/TNFa-EGF/100TNFa-100EGF/100TNF_100EGF_ANIMOvsFuzzy-crop}
\pgfdeclareimage[width=\textwidth]{CircadianComparison}{images/Circadian/ANIMOvsODE-crop}
...
\caption{{\bf (A)} The repressilator-like subnetwork used to represent the alternation
between day and night that cause the oscillations in {\sf CRY} concentrations in the
network modelled in the Results Section~\ref{sec:animo-drosophila}.
