...
\pgfdeclareimage[width=0.95\textwidth]{FigS10}{Figures/S10} %100TNF0EGF}{images/TNFa-EGF/100TNFa-0EGF/100TNF_0EGF_ANIMOvsFuzzy-crop}
\pgfdeclareimage[width=0.95\textwidth]{FigS11}{Figures/S11} %0TNF100EGF}{images/TNFa-EGF/0TNFa-100EGF/0TNF_100EGF_ANIMOvsFuzzy-crop}
\pgfdeclareimage[width=0.95\textwidth]{FigS12}{Figures/S12} %100TNF100EGF}{images/TNFa-EGF/100TNFa-100EGF/100TNF_100EGF_ANIMOvsFuzzy-crop}
\pgfdeclareimage[width=0.95\textwidth]{FigS6}{Figures/S6} %CircadianComparison}{images/Circadian/ANIMOvsODE-crop}
\pgfdeclareimage[width=0.9\textwidth]{Fig3}{Figures/3} %ANIMOvsODE-smaller-comparison}{images/Circadian/ANIMOvsODE_small_comparison-crop}
...
\title{Modelling with ANIMO:\\ between Fuzzy Logic and Differential Equations}%ODE vs Fuzzy Logic: in medio stat ANIMO}%Formal models of biological networks in \animo2{}} 
...
% The large amount of data an experimental biologist
% must deal with makes the use of computational methods essential
...
% that enriches the
% normally static biological network diagrams with dynamic information. An underlying formalism is used 
% to describe
% the dynamics of a network and its components. %, defining the executable model.
% The analysis of an executable model typically produces graphs and animations, which help understand how the network evolves with time.
% Executable models typically contain descriptions of the 
...
The influence of an ANIMO interaction is quantified by a scale factor $k$, which defines the speed at which
...
\begin{figure*}[!htpb]
\begin{center}
% \pgfuseimage{ANIMOvsODE-smaller-comparison}
  \pgfuseimage{Fig3}
\end{center}
...
Being less parameter-intensive than ODEs more precise than logic-based models,
...
transition. ${\sf t} < 20$ is called an invariant on the state, allowing residence in this state as long as local
...
\begin{minipage}{\textwidth}
\centering
% \subfloat[\label{suppl:fig1-1level}]{\includegraphics[width=.45\textwidth]{images/JNK1_1level3}} \qquad
% \subfloat[\label{suppl:fig1-10levels}]{\includegraphics[width=.45\textwidth]{images/JNK1_10levels3}} \\
% \subfloat[\label{suppl:fig1-50levels}]{\includegraphics[width=.45\textwidth]{images/JNK1_50levels3}} \qquad
% \subfloat[\label{suppl:fig1-100levels}]{\includegraphics[width=.45\textwidth]{images/JNK1_100levels3}}
...
%{\bfseries (\protect\subref*{suppl:fig1-1level})} %
{\bf(A)} 2 levels,
%{\bfseries (\protect\subref*{suppl:fig1-10levels})} %
{\bf(B)} 10 levels,
%{\bfseries (\protect\subref*{suppl:fig1-50levels})} %
{\bf (C)} 50 levels,
%{\bfseries (\protect\subref*{suppl:fig1-100levels})} %
{\bf (D)} 100 levels.
...
\begin{minipage}{\textwidth}
  \centering
% \begin{tabular}{ccc}
% \subfloat[clk]{\includegraphics[scale=\drosophilaGraphScale]{images/Circadian/clk_mRNA}} &
% \subfloat[CLK]{\includegraphics[scale=\drosophilaGraphScale]{images/Circadian/CLK_prot}} &
% \subfloat[CRY]{\includegraphics[scale=\drosophilaGraphScale]{images/Circadian/CRY_prot}} \\
% \subfloat[cwo]{\includegraphics[scale=\drosophilaGraphScale]{images/Circadian/cwo_mRNA}} &
% \subfloat[CWO]{\includegraphics[scale=\drosophilaGraphScale]{images/Circadian/CWO_prot}} &
% \subfloat[CYC/CLK]{\includegraphics[scale=\drosophilaGraphScale]{images/Circadian/CYC-CLK}} \\
% \subfloat[pdp1]{\includegraphics[scale=\drosophilaGraphScale]{images/Circadian/pdp1_mRNA}} &
% \subfloat[PDP1]{\includegraphics[scale=\drosophilaGraphScale]{images/Circadian/PDP1_prot}} &
% \subfloat[per]{\includegraphics[scale=\drosophilaGraphScale]{images/Circadian/per_mRNA}} \\
% \subfloat[PER]{\includegraphics[scale=\drosophilaGraphScale]{images/Circadian/PER_prot}} &
% \subfloat[PER/TIM]{\includegraphics[scale=\drosophilaGraphScale]{images/Circadian/PER-TIM}} &
% \subfloat[tim]{\includegraphics[scale=\drosophilaGraphScale]{images/Circadian/tim_mRNA}} \\
% \subfloat[TIM]{\includegraphics[scale=\drosophilaGraphScale]{images/Circadian/TIM_prot}} &
% \subfloat[vri]{\includegraphics[scale=\drosophilaGraphScale]{images/Circadian/vri_mRNA}} &
% \subfloat[VRI]{\includegraphics[scale=\drosophilaGraphScale]{images/Circadian/VRI_prot}}
% \end{tabular}
% \pgfuseimage{CircadianComparison}
  \pgfuseimage{FigS6}
